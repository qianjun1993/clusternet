	...
	tests := []struct {
		...
		},
		{
			nodeInfo: framework.NewNodeInfo(
				...
				[]*corev1.Pod{
					makePod("machine1", 1*ResourceUnitCPU, 4*ResourceUnitMem, 2*ResourceUnitEphemeralStorage),
					makePod("machine1", 6*ResourceUnitCPU, 4*ResourceUnitMem, 2*ResourceUnitEphemeralStorage),
				}),
			requirements: makeReplicaRequirements(1*ResourceUnitCPU, 1*ResourceUnitMem, ResourceUnitZero),
			want:         1,
		},
		{
			nodeInfo: framework.NewNodeInfo(
				...
				[]*corev1.Pod{
					makePod("machine1", 1*ResourceUnitCPU, 4*ResourceUnitMem, 2*ResourceUnitEphemeralStorage),
					makePod("machine1", 1*ResourceUnitCPU, 11*ResourceUnitMem, 2*ResourceUnitEphemeralStorage),
				}),
			requirements: makeReplicaRequirements(1*ResourceUnitCPU, 1*ResourceUnitMem, ResourceUnitZero),
			want:         1,
		},
