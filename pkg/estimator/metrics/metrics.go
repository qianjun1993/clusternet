...
var (
	estimatorAttempts = metrics.NewCounterVec(
		&metrics.CounterOpts{
			...
			Help:           "Number of attempts to estimator requirements, by the result. 'unschedulable' means a requirement could not be estimated, while 'error' means an internal estimator problem.",
